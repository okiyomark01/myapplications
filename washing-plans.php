...
<head>
    <meta charset="utf-8">
    <title>CARWASH SYSTEM | Washing Plans</title>
                ...
                <div class="col-md-4">
                    <div class="price-item">
                        <div class="price-header">
                            ...
                            <h2><span>Ksh</span><strong>200</strong><span>.00</span></h2>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="price-item featured-item">
                        <div class="price-header">
                            ...
                            <h2><span>Ksh</span><strong>500</strong><span>.00</span></h2>
                        </div>
                        <div class="price-body">
                            <ul>
                                <li><i class="far fa-check-circle"></i>Seats Washing</li>
                ...
                <div class="col-md-4">
                    <div class="price-item">
                        <div class="price-header">
                            ...
                            <h2><span>Ksh</span><strong>700</strong><span>.00</span></h2>
                        </div>
                        <div class="price-body">
                            <ul>
                                <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <form method="post">
                        <p>
                            <select name="packagetype" required class="form-control">
                                ...
                                <option value="1">BASIC CLEANING (Ksh.200.00)</option>
                                <option value="2">PREMIUM CLEANING (Ksh.500.00)</option>
                                <option value="3 ">COMPLEX CLEANING(Ksh.700.00)</option>
                            </select>
